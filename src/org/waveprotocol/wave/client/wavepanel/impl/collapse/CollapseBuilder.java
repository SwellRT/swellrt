...
/**
 * Builds and installs the collapse/expand feature.
 *
 */
public final class CollapseBuilder {
   ...
   * @return the feature.
   */
  public static CollapsePresenter createAndInstallIn(WavePanelImpl panel) {
    CollapsePresenter c = new CollapsePresenter();
    CollapseController.install(c, panel);
    return c;
  }
}
