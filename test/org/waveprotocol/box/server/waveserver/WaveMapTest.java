...
public class WaveMapTest extends TestCase {
  ...
  public void testSearchOrderByAscWorks() throws Exception {
    ...
    SearchResult results = waveMap.search(USER1, "in:inbox orderby:dateasc", 0, 10);
  ...
  public void testSearchOrderByDescWorks() throws Exception {
    ...
    SearchResult results = waveMap.search(USER1, "in:inbox orderby:datedesc", 0, 10);
  ...
  public void testSearchOrderByCreatedAscWorks() throws Exception {
    ...
    SearchResult results = waveMap.search(USER1, "in:inbox orderby:createdasc", 0, 10);
  ...
  public void testSearchOrderByCreatedDescWorks() throws Exception {
    ...
    SearchResult results = waveMap.search(USER1, "in:inbox orderby:createddesc", 0, 10);
