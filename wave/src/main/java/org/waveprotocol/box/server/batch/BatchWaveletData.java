...
/**
 * Represents a Wavelet to be used in a batch operation. It gathers wavelet ops
 * by possibly different participants and can offer up these operations as a
 * list of deltas.
 *
 * <p>
 * Copied from {@link RobotWaveletData}
 *
 */
public class BatchWaveletData {
  ...
  /**
   * Constructs a new {@link BatchWaveletData}. The given
   ...
   *        to generate deltas.
   */
  public BatchWaveletData(ReadableWaveletData snapshot, HashedVersion committedVersion) {
