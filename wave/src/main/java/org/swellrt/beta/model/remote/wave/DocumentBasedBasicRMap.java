...
public final class DocumentBasedBasicRMap<E, K, V>
 extends AbstractDocumentBasedRMap<E, K, V> {
   ...
   */
  DocumentBasedBasicRMap(DocumentEventRouter<? super E, E, ?> router,
   ...
   * Creates a Basic Map.
   */
  public static <E, K, V> DocumentBasedBasicRMap<E, K, V> create(
      DocumentEventRouter<? super E, E, ?> router,
      E entryContainer, Serializer<K> keySerializer, Serializer<V> valueSerializer,
      String entryTagName, String keyAttrName, String valueAttrName) {
    DocumentBasedBasicRMap<E, K, V> map = new DocumentBasedBasicRMap<E, K, V>(
  ...
  protected boolean isRedundantPut(V oldValue, V newValue) {
    ...
    // Allow redundat put to make swellrt works on events
