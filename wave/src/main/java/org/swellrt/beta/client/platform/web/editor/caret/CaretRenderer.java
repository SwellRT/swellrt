 ...
 */
public class CaretRenderer implements Renderer {
  ...
  /** Singleton instance: */
  private static final CaretRenderer instance = new CaretRenderer();

  public static CaretRenderer getInstance() {
    return instance;
  }

  private CaretRenderer() { }
  ...
  /*
   * public void setMarker(Object element, CaretView marker) { // Hack for bug
   * 2868754 Element impl = ((ContentElement) element).getImplNodelet();
