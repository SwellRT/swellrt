 ...
 *
 * (pablojan) The caret view has a marker and a label for the user name.
 *
 * The marker will be visible always until user stops edition.
 *
 * The user name's label will be only visible on mouse over.
 *
 * @author danilatos@google.com (Daniel Danilatos)
 * @author pablojan@gmail.com (Pablo Ojanguren)
 */
public class CaretWidget {
