 ...
 * made in
 * {@link org.waveprotocol.JavaSnapshotSerializer.service.common.common.SnapshotSerializer}
 * 
 * @author Joseph Gentle (josephg@gmail.com)
 * 
 *         Modified version for using Gson objects in Android/Java client
 */
public class JavaSnapshotSerializer {
  private JavaSnapshotSerializer() {
  }
  ...
  public static WaveletSnapshot serializeWavelet(ReadableWaveletData wavelet,
    ...
    builder.setVersion(JavaWaveletOperationSerializer.serialize(hashedVersion));
  ...
  public static ObservableWaveletData deserializeWavelet(WaveletSnapshot snapshot, WaveId waveId,
    ...
    ObservableWaveletData wavelet = factory.create(new EmptyWaveletSnapshot(waveId, waveletId,
            author, JavaWaveletOperationSerializer.deserialize(snapshot.getVersion()),
            creationTime));
  ...
  public static DocumentSnapshot serializeDocument(ReadableBlipData document) {
    ...
    builder.setDocumentOperation(JavaWaveletOperationSerializer.serialize(
  ...
  private static void addDocumentSnapshotToWavelet(
    ...
    DocOp op = JavaWaveletOperationSerializer.deserialize(snapshot.getDocumentOperation());
