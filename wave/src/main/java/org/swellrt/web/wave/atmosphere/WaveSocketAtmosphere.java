...
package org.swellrt.web.wave.atmosphere;

import com.google.gwt.core.client.Callback;
import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.core.client.ScriptInjector;

import org.swellrt.web.wave.WaveSocket;
      ...
      private static final class AtmosphereSocket extends JavaScriptObject {
        ...
        public static native AtmosphereSocket create(WaveSocketAtmosphere impl, String urlBase, String transport, String fallback, String clientVersion, String sessionId) /*-{
          ...
          socket.request.onOpen = function(response) {
            impl.@org.swellrt.web.wave.atmosphere.WaveSocketAtmosphere::onConnect()();
          };
          ...
          socket.request.onMessage = function(response) {
            impl.@org.swellrt.web.wave.atmosphere.WaveSocketAtmosphere::onMessage(Ljava/lang/String;)(response.responseBody);

          };

          // CLOSE
          socket.request.onClose = function(response) {
            impl.@org.swellrt.web.wave.atmosphere.WaveSocketAtmosphere::onDisconnect()();
          };
          ...
          socket.request.onError = function(response) {
            impl.@org.swellrt.web.wave.atmosphere.WaveSocketAtmosphere::onError(Ljava/lang/String;)(response.status);
          };

          // CLIENT TIMEOUT
          socket.request.onClientTimeout = function(request) {
            impl.@org.swellrt.web.wave.atmosphere.WaveSocketAtmosphere::reconnect()();
          };
