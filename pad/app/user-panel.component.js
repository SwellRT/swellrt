System.register(['@angular/core', './service/swellrt.service', '@angular/router-deprecated'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, swellrt_service_1, router_deprecated_1;
        ...
        execute: function() {
            UserPanelComponent = (function () {
                ...
                UserPanelComponent.prototype.logout = function () {
                    var _this = this;
                    this._swellrt.logout(true).then(function (user) { return _this.loggedInUser = user; });
                };
                ...
                UserPanelComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_deprecated_1.Router, swellrt_service_1.SwellRTService])
                ], UserPanelComponent);
